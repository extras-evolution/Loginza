...
class MODxLoginza
{
    ...
    function __construct($providers,$landing_url,$secret,$debug,$login_id,$register_id)
    {
        ...
        $this->button = '<script src="http://loginza.ru/js/widget.js" type="text/javascript"></script><h3><a href="https://loginza.ru/api/widget?providers_set='.$providers.'&token_url='.$landing_url.'" class="loginza"><img src="http://loginza.ru/favicon.ico" alt="Loginza"/> '.DEFAULT_ENTER.'</a></h3>';
